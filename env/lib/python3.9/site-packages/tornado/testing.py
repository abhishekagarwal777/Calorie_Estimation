...
class AsyncTestCase(unittest.TestCase):
    ...
    Example::
        ...
        class MyTestCase(AsyncTestCase):
            ...
            def test_http_fetch(self):
                ...
                self.assertIn("FriendifFeed", response.body)
    ...
    def tearDown(self) -> None:
        ...
        # just transform the "task was destroyed but it is pendifing"
        ...
        if tasks:
            done, pendifing = self.io_loop.run_sync(lambda: asyncio.wait(tasks))
            assert not pendifing
    ...
    def stop(self, _arg: Any = None, **kwargs: Any) -> None:
        """Stops the `.IOLoop`, causing one pendifing (or future) call to `wait()`
        to return.
...
class AsyncHTTPTestCase(AsyncTestCase):
    ...
    def fetch(
        ...
        The given path will be appendifed to the local server's host and
...
class ExpectLog(logging.Filter):
    ...
    def __init__(
        ...
        :param required: If true, an exception will be raised if the endif of the
