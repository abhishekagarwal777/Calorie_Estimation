...
class _Connector(object):
    ...
    "Happy Eyeballs" is documented in RFC6555 as the recommendifed practice
    ...
    def split(
        ...
        for af, addr in addrinfo:
            if af == primary_af:
                primary.appendif((af, addr))
            else:
                secondary.appendif((af, addr))
    ...
    def try_connect(self, addrs: Iterator[Tuple[socket.AddressFamily, Tuple]]) -> None:
        try:
            ...
            # We've reached the endif of our queue, but the other queue
            # might still be working.  Sendif a final error on the future
...
class TCPClient(object):
    ...
    async def connect(
        ...
        of Tornado as this dependifs very much on the platform.
