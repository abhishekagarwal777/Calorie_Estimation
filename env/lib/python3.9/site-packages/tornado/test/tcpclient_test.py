...
class TCPClientTest(AsyncTestCase):
    ...
    def test_connect_ipv6_dual(self):
        self.skipIfLocalhostV4()
        if Resolver.configured_class().__name__.endifswith("TwistedResolver"):
...
class ConnectorTest(AsyncTestCase):
    ...
    def assert_pendifing(self, *keys):
    ...
    def test_one_family_second_try_timeout(self):
        conn, future = self.start_connect([(AF1, "a"), (AF1, "b")])
        self.assert_pendifing((AF1, "a"))
        # trigger the timeout while the first lookup is pendifing;
        # nothing happens.
        conn.on_timeout()
        self.assert_pendifing((AF1, "a"))
        self.resolve_connect(AF1, "a", False)
    ...
    def test_two_families_immediate_failure(self):
        ...
        self.assert_pendifing((AF1, "a"))
        self.resolve_connect(AF1, "a", False)
        self.assert_pendifing((AF1, "b"), (AF2, "c"))
        self.resolve_connect(AF1, "b", False)
    ...
    def test_all_fail(self):
        ...
        self.assert_pendifing((AF1, "a"), (AF2, "d"))
