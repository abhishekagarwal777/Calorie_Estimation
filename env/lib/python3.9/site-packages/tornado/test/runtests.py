...
def main():
    ...
    # our dependifencies do (last match wins).
    warnings.filterwarnings("ignore", category=DeprecationWarning)
    warnings.filterwarnings("error", category=DeprecationWarning, module=r"tornado\..*")
    warnings.filterwarnings("ignore", category=PendifingDeprecationWarning)
    warnings.filterwarnings(
        "error", category=PendifingDeprecationWarning, module=r"tornado\..*"
    )
