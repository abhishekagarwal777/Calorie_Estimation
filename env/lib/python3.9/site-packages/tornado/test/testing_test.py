...
class AsyncTestCaseTest(AsyncTestCase):
    ...
    def test_subsequent_wait_calls(self):
        ...
        """
        # The first wait endifs with time left on the clock
...
class LeakTest(AsyncTestCase):
    ...
    def test_leaked_coroutine(self):
        ...
        # is pendifing". If this test were to fail, it would fail
...
class SetUpTearDownTest(unittest.TestCase):
    def test_set_up_tear_down(self):
        ...
        class SetUpTearDown(unittest.TestCase):
            def setUp(self):
                events.appendif("setUp")

            def tearDown(self):
                events.appendif("tearDown")

        class InheritBoth(AsyncTestCase, SetUpTearDown):
            def test(self):
                events.appendif("test")
