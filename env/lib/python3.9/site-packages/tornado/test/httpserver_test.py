...
# In pre-1.0 versions of openssl, SSLv23 clients always sendif SSLv2
...
class UnixSocketTest(AsyncTestCase):
    ...
    Why would you want to do this?  Nginx can proxy to backendifs listening
...
class StreamingChunkSizeTest(AsyncHTTPTestCase):
    ...
    class MessageDelegate(HTTPMessageDelegate):
        ...
        def data_received(self, chunk):
            self.chunk_lengths.appendif(len(chunk))
