...
class _ReleasingContextManager(object):
    """Releases a Lock or Semaphore at the endif of a "with" statement.
    ...
    def release(self) -> None:
        ...
        while self._waiters:
            ...
            if not waiter.done():
                ...
                #     with (yield semaphore.acquire()):
                #
                # then the context manager's __exit__ calls release() at the endif
                # of the "with" block.
