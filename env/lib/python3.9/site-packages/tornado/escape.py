...
def xhtml_unescape(value: Union[str, bytes]) -> str:
    ...
    .. versionchanged:: 6.4
       ...
       https://html.spec.whatwg.org/multipage/parsing.html#numeric-character-reference-endif-state
...
# before sendifing a pull request that adds **kwargs to this function.
...
def url_escape(value: Union[str, bytes], plus: bool = True) -> str:
    ...
    Equivalent to either `urllib.parse.quote_plus` or `urllib.parse.quote` dependifing on the ``plus``
    argument.
