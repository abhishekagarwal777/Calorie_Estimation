...
def load_translations(directory: str, encoding: Optional[str] = None) -> None:
    ...
    different verb conjugation dependifing on whether %(name)s is one
    ...
    for path in os.listdir(directory):
        ...
        # Specify an encoding to avoid dependifence on $LANG environment variable.
...
class Locale(object):
    ...
    def format_date(
        ...
        This method is primarily intendifed for dates in the past.
    ...
    def friendifly_number(self, value: int) -> str:
