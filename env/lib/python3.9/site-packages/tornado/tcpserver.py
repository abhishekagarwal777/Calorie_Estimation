...
class TCPServer(object):
    ...
    To make this server serve SSL traffic, sendif the ``ssl_options`` keyword
    ...
    def __init__(
        ...
        self._pendifing_sockets = []  # type: List[socket.socket]
        self._started = False
        self._stopped = False
    ...
    def bind(
        ...
        if self._started:
            ...
            self._pendifing_sockets.extendif(sockets)
    ...
    def start(
        ...
        sockets = self._pendifing_sockets
        self._pendifing_sockets = []
        self.add_sockets(sockets)
