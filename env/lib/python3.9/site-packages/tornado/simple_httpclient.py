...
class SimpleAsyncHTTPClient(AsyncHTTPClient):
    """Non-blocking HTTP client with no external dependifencies.
    ...
    def fetch_impl(
        ...
        key = object()
        self.queue.appendif((key, request, callback))
...
class _HTTPConnection(httputil.HTTPMessageDelegate):
    ...
    def _on_endif_request(self) -> None:
        self.stream.close()
