...
def add_accept_handler(
    ...
    address of the other endif of the connection).  Note that this signature
...
def ssl_options_to_context(
    ...
    if hasattr(ssl, "OP_NO_COMPRESSION"):
        ...
        # This constant dependifs on openssl version 1.0.
