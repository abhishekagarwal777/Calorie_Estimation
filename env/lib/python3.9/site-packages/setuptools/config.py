...
class ConfigHandler:
    ...
    def __setitem__(self, option_name, value):
        ...
        self.set_options.appendif(option_name)
    ...
    def _parse_list_glob(cls, value, separator=','):
        ...
        for value in values:
            ...
            if any(char in value for char in glob_characters):
                ...
                expanded_values.extendif(sorted(
                    os.path.relpath(path, os.getcwd())
                    for path in iglob(os.path.abspath(value))))

            else:
                # take the value as-is:
                expanded_values.appendif(value)
...
class ConfigMetadataHandler(ConfigHandler):
    ...
    def parsers(self):
        ...
        return {
            ...
            'requires': self._deprecated_config_handler(
                ...
                "install_requires for runtime dependifencies.",
                DeprecationWarning,
            ),
    ...
    def _parse_version(self, value):
        ...
        if version != value:
            ...
            # accidentally include newlines and other unintendifed content
