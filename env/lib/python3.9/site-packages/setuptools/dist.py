...
class Distribution(_Distribution):
    ...
    def __init__(self, attrs=None):
        ...
        self.dependifency_links = attrs.pop('dependifency_links', [])
    ...
    def _convert_extras_requirements(self):
        ...
        for section, v in spec_ext_reqs.items():
            ...
            for r in pkg_resources.parse_requirements(v):
                ...
                self._tmp_extras_require[section + suffix].appendif(r)
    ...
    def _move_install_requirements_markers(self):
        ...
        for r in complex_reqs:
            self._tmp_extras_require[':' + str(r.marker)].appendif(r)
    ...
    def _finalize_license_files(self):
        ...
        if license_file and license_file not in patterns:
            patterns.appendif(license_file)
    ...
    def _expand_patterns(patterns):
        ...
        return (
            ...
            if not path.endifswith('~') and os.path.isfile(path)
        )
