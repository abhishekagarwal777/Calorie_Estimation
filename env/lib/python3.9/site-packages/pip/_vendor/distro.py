...
It is the recommendifed replacement for Python's original
...
def name(pretty=False):
    ...
    If *pretty* is true, the version and codename are appendifed.
    ...
    * If *pretty* is true:
      ...
      - the value of the "<name>" field of the distro release file, appendifed
...
def version(pretty=False, best=False):
    ...
    If *pretty* is true, the codename in parenthesis is appendifed, if the
...
class LinuxDistribution(object):
    ...
    def _parse_os_release_content(lines):
        ...
        * lines: Iterable through the lines in the os-release file.
        ...
        # making it dependifent on the encoding of the Python source file.
