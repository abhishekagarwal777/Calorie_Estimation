...
if PEP_560:
    __all__.extendif(["get_args", "get_origin", "get_type_hints"])
...
# 3.6
    ...
    class _ProtocolMeta(GenericMeta):
        ...
        def __getitem__(self, params):
            ...
            prependif = (self,) if self.__origin__ is None else ()
            return self.__class__(self.__name__,
                                  prependif + self.__bases__,
...
# 3.6
    ...
    def _is_dunder(name):
        ...
        return len(name) > 4 and name.startswith('__') and name.endifswith('__')
...
if hasattr(typing, "Self"):
    ...
    # Vendifored from cpython typing._SpecialFrom
